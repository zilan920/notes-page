import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-vg2OS4np.js";const i={},l=e(`<h2 id="思路" tabindex="-1"><a class="header-anchor" href="#思路" aria-hidden="true">#</a> 思路</h2><ul><li>双指针与链表 <ul><li><p>合并有序链表</p><ul><li>拉链法</li><li>多个链表合并：优先队列</li></ul></li><li><p>拆分链表</p><p>直接使用两个节点遍历，按条件分别生成两个链表，最后合并起来，注意中途要拆分原有的关联</p></li><li><p>合并k个有序链表</p><p>类似合并2个有序链表，但这里使用到了优先级队列，快速找到最小的节点。优先级队列属于单独的数据结构，需要了解</p></li><li><p>单链表的倒数第 k 个节点</p><p>两个指针，第一个先走k步，再将两个指针一起走，最后第一个指针到达尾部时，第二个刚好走了n-k步<br> 类似的还有删除倒数第k个节点</p></li><li><p>链表中点</p><p>直接使用快慢指针</p></li><li><p>判断是否包含环</p><p>使用快慢指针，如果两个指针相交则表示包含环，相交后任意一个节点回到头，然后相同速度往前走，再次相交则为相交的起点。</p></li><li><p>两个链表是否相交</p><p>两个指针分别依次走两个链表，最后看是否相交。<br> 类似的，也可以将两个链表首位相连，判断是否存在环</p></li><li><p>递归反转</p></li></ul></li></ul><div class="language-golang line-numbers-mode" data-ext="golang"><pre class="language-golang"><code>func reverse(ListNode head) ListNode {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>双指针与数组</p></li><li><p>有序数组二分搜索</p><ul><li><p>二分搜索重在细节，特别是左右边界的判断，以及判断之后mid的变化</p></li><li><p>二分不仅仅用于显然的搜索场景，也可以用于一些特殊的搜索场景（如求极值）</p><p>在这类场景下，搜索目标往往不是一个清晰的数组，有时会是一个线性函数，需要结合具体例子来判断能够使用二分搜索。</p></li><li><p>田忌赛马</p><p>思路：比得过就比，比不过就用最差的来应对</p></li><li><p>快慢指针</p><ul><li><p>原地修改数组</p><p>删除排序数组中的重复元素等，直接使用快慢指针，发现一个与慢指针不同的时，将慢指针设置为新值，这样从0到慢指针就都为不同的元素了。</p></li></ul></li><li><p>左右指针</p><ul><li><p>二分查找</p><p>二分查找是一种左右指针的应用</p></li><li><p>两数之和，但是是有序数组</p><p>一左一右指针，相加和，如果结果大了则右边往左，结果小了则左边往右，如果指针相遇则没有结果</p></li><li><p>翻转数组</p><p>一左一右互换即可</p></li><li><p>判断回文</p><p>一左一右判断是否相等，一直持续到指针相遇。<br> 判断最长回文子串，也就是从中间开始向两边试图查找回文串，注意中心可能是当前字符，也可能是当前和接下来的字符</p></li></ul></li></ul></li><li><p>动态规划法</p><p>核心思想在于找到分解问题，将问题降级再重新组装<br> 斐波那契数列：分解为前面2个数之和<br> 最长递增自学：当前序列是否为递增，新增下一个值是否依然为递增</p></li><li><p>回溯法</p><p>代码框架</p></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    result = []
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>有序数组二分搜索</li><li>原地修改数组</li><li>单链表 <ul><li>链表合并，链表分割</li><li>链表倒数第k个节点</li><li>链表中点，是否有环</li><li>两个链表是否相交</li></ul></li><li>递归操作链表</li></ul><h4 id="队列-栈" tabindex="-1"><a class="header-anchor" href="#队列-栈" aria-hidden="true">#</a> 队列/栈</h4><ul><li>队列和栈相互实现</li><li>括号匹配问题</li></ul><h4 id="数据结构设计" tabindex="-1"><a class="header-anchor" href="#数据结构设计" aria-hidden="true">#</a> 数据结构设计</h4><ul><li>LRU算法</li><li>LFU算法</li><li>查找/删除数组中任意元素</li></ul><h3 id="进阶数据结构" tabindex="-1"><a class="header-anchor" href="#进阶数据结构" aria-hidden="true">#</a> 进阶数据结构</h3><h4 id="二叉树" tabindex="-1"><a class="header-anchor" href="#二叉树" aria-hidden="true">#</a> 二叉树</h4><h4 id="二叉搜索树" tabindex="-1"><a class="header-anchor" href="#二叉搜索树" aria-hidden="true">#</a> 二叉搜索树</h4><h4 id="图" tabindex="-1"><a class="header-anchor" href="#图" aria-hidden="true">#</a> 图</h4><h3 id="暴力算法" tabindex="-1"><a class="header-anchor" href="#暴力算法" aria-hidden="true">#</a> 暴力算法</h3><ul><li>DFS/回溯算法</li><li>BFS算法</li></ul><h3 id="动态规划" tabindex="-1"><a class="header-anchor" href="#动态规划" aria-hidden="true">#</a> 动态规划</h3><h4 id="经典动态规划" tabindex="-1"><a class="header-anchor" href="#经典动态规划" aria-hidden="true">#</a> 经典动态规划</h4><h4 id="背包问题" tabindex="-1"><a class="header-anchor" href="#背包问题" aria-hidden="true">#</a> 背包问题</h4>`,31),t=[l];function p(c,d){return s(),a("div",null,t)}const r=n(i,[["render",p],["__file","Leetcode.html.vue"]]);export{r as default};
